  ...
  return /*html*/ `<div class="task-view" draggable="true" ondrag="drag(event)" ondragstart="dragstart(event, '${taskId}')" ondragend="dragEnd()" onclick="openTaskDetail('${taskId}')">
                    <div class="task-view-top">
                      <div class="category-move-task-container">
                        ...
                        <svg onclick="openMoveTaskDropdown(event)" enable-background="new 0 0 16 32" id="Glyph" version="1.1" viewBox="0 0 32 32" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"> 
                        ...
                        <div id="move-task-dropdown" class="move-task-dropdown d-none" onclick="event.stopPropagation()">
                          <p>To do</p>
                          <p>In progress</p>
                          <p>Await Feedback</p>
                          <p>Done</p>
